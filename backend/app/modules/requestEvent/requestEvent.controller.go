...
func (rc *RequestEventController) GetRequest(c *gin.Context) {
	...
	if err != nil {
		utility.SendResponse(c, 400, false, "Not able to fetched requests", nil, err.Error())
		return
	}
...
func (rc *RequestEventController) DeleteRequest(c *gin.Context) {
	...
	if err := rc.requestService.DeleteRequest(userId, reqId); err != nil {
		utility.SendResponse(c, 400, false, "Not able to delete the request", nil, err.Error())
		return
	}
